> ⚠️ **SUPERSEDED — archived snapshot, v1, 2026-09-04.** Kept for the record because its
> evidence (the Azure-era verification run) is cited in article #10's draft. The live doc is
> `platform/litellm/README.md`. Everything below describing Azure OpenAI is now historical: the
> Azure resource was deleted on/before 2026-09-18 and the gateway is all-Bedrock.
